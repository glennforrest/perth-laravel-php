<x-layout>
    <x-hero title="Code of Conduct"></x-hero>
    ...
    <div class="container max-w-4xl py-24">
        <div class="prose-lg prose-p:text-body prose-a:underline">
            ...
            <p>If you have any questions, or are harassed in any way, please contact one of our staff. All reports are confidential. The organiser email address is: {{ config('app.organiser.email') }}</p>
            ...
            <p>CONTACT US AT {{ config('app.organiser.email') }}</p>
        </div>
    </div>
</x-layout>
